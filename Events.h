...
uint16_t getWave(byte waveType, uint32_t pos);
void AD1_OnEnd(void);
/*
** ===================================================================
...
void TimerStepper_OnInterrupt(void);
/*
** ===================================================================
**     Event       :  TimerStepper_OnInterrupt (module Events)
**
**     Component   :  TimerStepper [TimerInt]
**     Description :
